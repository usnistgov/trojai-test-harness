...
#python plot_2term_interactions.py --factor-global-results-csv-filepath=${OUTPUT_DIR}/es-global-results.csv --output-dirpath=${OUTPUT_DIR}/2term-mean-effects-plots
